      ...
      <main className="main-container">
        ...
        {currentConversation.messages.length === 0 ? (
          ...
          <div className="welcome-container">
            <img className="welcome-logo" src="src/images/cropnexus draft logo.png" alt="Cropnexus AI Logo" />
            <h1 className="welcome-heading">Message Cropnexus AI</h1>
            ...
            <p className="language-support">
              Supports 3 languages: English, Hindi (हिंदी), Bengali (বাংলা)
            </p>
          </div>
        ) : (
          // Messages container
        ...
        <div className="prompt-container">
          ...
          <p className="disclaimer-text">Cropnexus AI can make mistakes, so double-check it.</p>
        </div>
      </main>
    </div>
  );
