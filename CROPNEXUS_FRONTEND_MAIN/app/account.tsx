...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { opacity: 0.9, color: "white", marginTop: 8 },
  ...
  photoActions: { flexDirection: "row", gap: 15, marginTop: 20 },
  btn: { paddingVertical: 10, paddingHorizontal: 20, borderRadius: 6 },
  btnPrimary: { backgroundColor: "#04ad3f" },
  btnTextPrimary: { color: "white", fontWeight: "500" },
  btnOutline: { borderWidth: 1, borderColor: "#ddd" },
  btnTextOutline: { color: "#777" },
  formGroup: { marginBottom: 20 },
  label: { marginBottom: 8, fontWeight: "500", color: "#555" },
  formControl: {
    width: "100%",
    padding: 12,
    borderWidth: 1,
