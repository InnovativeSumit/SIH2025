...
const styles = StyleSheet.create({
  ...
  title: { fontWeight: "600", fontSize: 28, color: "white", marginBottom: 8 },
  subtitle: { opacity: 0.9, fontSize: 16, color: "white" },
  ...
  icon: { position: "absolute", right: 16, top: 14 },
  passwordStrength: {
    height: 5,
  ...
  passwordStrengthBar: { height: "100%" },
  passwordRequirements: { marginTop: 5, fontSize: 13, color: "#ffffff" },
  btn: {
    width: "100%",
    padding: 16,
    borderRadius: 25,
  ...
  socialLogin: { flexDirection: "row", justifyContent: "center", gap: 16 },
  socialBtn: {
    width: 50,
    height: 50,
    borderRadius: 25,
